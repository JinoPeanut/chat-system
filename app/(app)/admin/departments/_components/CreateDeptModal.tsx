...
export default function CreateDeptModal({ fetchDeptData, onClose, managerCandidates }: CreateDeptModalProps) {
    ...
    const handleCreateDept = async (form: CreateDeptForm) => {
